...
<body>
  ...
  <div class="limiter">
    <div class="container-login100" style="background-image: url('assets/Admin/Special/images/bg-01.jpg');">
      <div class="wrap-login100">
        <form class="login100-form validate-form" action="<?php echo site_url('Admin/chkAdminForForgetPassword') ?>" method="post">
  ...
  <?php echo $this->session->flashdata('message'); ?>
          ...
          <div class="wrap-input100 validate-input" data-validate = "Enter Your Email">
            <input class="input100" type="text" name="admin_email" placeholder="Enter Your Email">
          ...
          <div class="contact100-form-checkbox">
            ...
            <label class="" >
              <a href="<?php echo site_url('Admin/index') ?>" style="color:white">
               <!-- Login -->
              </a>
