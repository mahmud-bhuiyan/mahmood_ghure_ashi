<div class="container">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo $p->mobaile_number ?></td>
      <td><button class="btn btn-success"><a style="color:#ffff" href="<?php echo base_url('admin/updateStateForUR/'.$p->id) ?>">Accept</a></button></td>
