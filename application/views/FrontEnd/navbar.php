...
<div class="super_container">
  ...
  <div class="dropdown">
    <button class="dropbtn"><i style="font-size: 20px;margin-left: 30px" class="fa fa-suitcase"></i> 
      <i class="fa fa-caret-down"></i>
    </button>
    <div class="dropdown-content">
      <a style="" href="<?php echo base_url('home/customerPackage') ?>">Your Package</a>
      <a style="" href="<?php echo base_url('home/customerWithGuide') ?>">Your Guide</a>
    ...
    <div class="dropdown-content">
      <a style="" href="<?php echo base_url('home/customerRequestToGuide') ?>">Your Customer</a>
      <a style="" href="<?php echo base_url('home/logout') ?>">Logout</a>
